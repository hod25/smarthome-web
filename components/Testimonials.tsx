  ...
  return (
    <section id="testimonials-section" className="py-8 bg-white border-b border-blue-100">
      <div className="container mx-auto max-w-3xl text-center">
        ...
        <div className="flex md:grid md:grid-cols-3 gap-6 overflow-x-auto md:overflow-visible snap-x md:snap-none pb-4">
          {testimonials.map((item, idx) => (
            <div key={idx} className="bg-blue-50 rounded-xl p-4 shadow text-right min-w-[80vw] max-w-xs mx-2 snap-center md:min-w-0 md:max-w-none">
